...
load_env() {
  ...
  export OBFUSCATOR_OBFUSCATE_BYTES="${OBFUSCATOR_OBFUSCATE_BYTES:-0}"
  export OBFUSCATOR_MEDIA_PT="${OBFUSCATOR_MEDIA_PT:-0}"
  export OBFUSCATOR_MEDIA_SSRC="${OBFUSCATOR_MEDIA_SSRC:-0}"
  export OBFUSCATOR_MEDIA_CLOCK="${OBFUSCATOR_MEDIA_CLOCK:-0}"
