...
//export PhobosTunnelService
func PhobosTunnelService(confFile16 *uint16) bool {
...
//export PhobosGenerateKeypair
func PhobosGenerateKeypair(publicKey, privateKey *byte) {
