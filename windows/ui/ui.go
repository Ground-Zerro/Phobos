...
func RunUI() {
	...
	if shouldQuitManagerWhenExiting {
		...
		if err != nil {
			showErrorCustom(nil, l18n.Sprintf("Error Exiting Phobos"), l18n.Sprintf("Unable to exit service due to: %v. You may want to stop Phobos from the service manager.", err))
		}
	}
}
