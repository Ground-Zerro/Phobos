...
class SettingsActivity : AppCompatActivity() {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, key: String?) {
            ...
            preferenceManager.findPreference<Preference>("tunnel_auto_switch_settings")?.setOnPreferenceClickListener {
                startActivity(Intent(requireContext(), TunnelSwitchSettingsActivity::class.java))
                true
            }
